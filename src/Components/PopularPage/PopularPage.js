...
const PopularPage = () => {
    ...
    return (
        ...
        <React.Fragment>
            <div className="popular-products" id="favs">
                        ...
                        <div className="col-md-12 mt-5 mb-5">
                            <div className="row ml-4" >
                                <div className="col-lg-4 card-col">
                                    <a href="/Products#Cookies" className="fav-link">
                                ...
                                <div className="col-lg-4 card-col">
                                    <a href="/Products#treats" className="fav-link">
                                        <Card className="pop-card" >
                                ...
                                <div className="col-lg-4 card-col">
                                    <a href="/Products#Cakes" className="fav-link">
                                        <Card className="pop-card">
