  ...
  const slider = (
    <FadeIn transitionDuration="4000">
      <AwesomeSlider className="mb-1" >
        <div data-src={'https://firebasestorage.googleapis.com/v0/b/joyflobites.appspot.com/o/Reviews%2Fcookie_flo_review2.png?alt=media&token=3c2adff5-7118-459b-b857-29c0172483af'} />
